...
* Any Mule runtime version will support all earlier SDK versions, so a module built for Mule 4.1 will work with any later Mule 4.x version on Java 8 or 11. For Java 17 (Mule 4.6 and later), modules may need updates to declare compatibility.
