...
For all pagination strategies, you must define name, type, and other
...
* name +
String that identifies the pagination through the connector descriptor. Use the
pagination name when an operation is paged using this strategy.

* type +
Defines the behavior of the pagination strategy. Use `_offset_` when
using this strategy.
...
* type +
Defines the behavior of the pagination strategy. Use `_marker_` when
using this strategy.
...
* name +
String that identifies the pagination through the connector descriptor. Use
the pagination name when an operation is paged using this strategy.

* type +
Defines the behavior of the pagination strategy. Use `_pageNumber_` when
using this strategy.
...
* type +
Defines the behavior of the pagination strategy. Use `_hypermedia_` when
using this strategy.
...
To define a pagination strategy, create a pagination node inside the
