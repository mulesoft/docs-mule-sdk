...
To define a multipart request, you must add properties to the attachment endpoint.
...
To set a display name for a part, you must use the `displayName` property, which
...
To set a description for a part, you must use the `description` property,
...
To define file parts, you must use the `file` property, which is added to the
attachment endpoint.
...
To define the content type of a part, you must use the `contentType` property,
which is added to the attachment endpoint.
...
To redefine the expected content for a part, you must use the `inputType`
