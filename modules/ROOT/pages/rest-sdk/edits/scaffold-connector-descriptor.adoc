...
as your API specification. If you must modify your API specification and a new
...
You can also add additional parameters to the `createDescriptor` mojo using
the `-D` prefix. In the example command above, the *apiSpec* parameter is added using
the `-D` prefix since it is a required parameter. The `createDescriptor` mojo uses
