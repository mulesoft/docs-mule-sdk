...
* Short connector build times, sometimes from several months to days or minutes // creation?
...
. xref:rest-sdk/features.adoc[Features in REST SDK]
+
Learn about REST SDK features and use cases.

. xref:rest-sdk/project-setup.adoc[Set Up and Install REST SDK]
+
