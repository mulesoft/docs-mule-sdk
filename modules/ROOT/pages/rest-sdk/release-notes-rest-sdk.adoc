...
* Added support for custom Composer metadata in IO metadata types. (RSDK-495, RSDK-242)
* Min mule version is now 4.3.0 for all generated connectors. (RSDK-521)
...
|nextUrl is not incorrectly modified anymore for hypermedia pagination. | (RSDK-500)
|RestSampleDataProvider now generates the corresponding output attributes. | (RSDK-509)
|===
