...
For instance, in the xref:rest-sdk/simple-composition-patterns.adoc#Salesforce Create Single Object[example for create-single],
...
Consider the opposite case of the xref:rest-sdk/simple-composition-patterns.adoc#Making an Optional Parameter Required[previous example].
