...
To create the customization layer, run the `createConnector` mojo:
...
and then the connector _name_ is overwritten in a second descriptor layer, the
final generated connector will have the name of the second layer and the description
of the first layer.
