...
Even though both options are supported, we strongly encourage the use of operationId when available, as it consists in a more sustainable choice throughout the evolution and changes the API spec may face.
