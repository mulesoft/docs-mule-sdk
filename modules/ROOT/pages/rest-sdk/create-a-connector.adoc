...
xref:rest-sdk/create-a-customization-layer.adoc[add a customization layer], which develops
another layer of functionality for your connector. Otherwise, you can
xref:rest-sdk/customize-your-connector.adoc[customize your connector] to start
