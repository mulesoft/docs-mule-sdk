...
*This step is optional* as Maven will automatically download the plugin when you try to use it
but it is useful as it allows you to be sure that you have access to the repositories and
