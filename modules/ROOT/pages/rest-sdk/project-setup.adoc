...
Maven automatically downloads the plugin when you try to use it.

You can run the following command to ensure you have access to necessary repositories and the latest plugin version:

----
mvn dependency:get -Dartifact=com.mulesoft.connectivity:rest-sdk-mojo:RELEASE -DrepoUrl=https://repository.mulesoft.org/nexus/content/repositories/releases
----
...
You can omit this parameter, and the latest version will be used.
