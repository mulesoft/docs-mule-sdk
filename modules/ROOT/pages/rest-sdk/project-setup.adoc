...
Allowed values are RAML, JsonOAS, YamlOAS, JsonOAS3 and YamlOAS3. For specFormats that are not supported, use https://www.apimatic.io/transformer/[API Transformer] by APIMatic to transform them into OAS or RAML to use the tooling provided by REST SDK.
