...
* Use a Mojo to scaffold a Connector Descriptor for an API Spec.
...
Maven automatically downloads the plugin when you try to use it. Optionally, you can run the following command to ensure you have access to necessary repositories and the latest plugin version:

----
mvn dependency:get -DgroupId=com.mulesoft.connectivity -DartifactId=rest-sdk-mojo -Dversion=0.1.2
----
