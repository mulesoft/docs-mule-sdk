...
=== Get access to the Mulesoft's Maven Repository

Mulesoft repositories are public, you only need to configure Maven to access them.

You can find the settings.xml Maven configuration file in the following locations:
....
...
There, you will need to add a new plugin repository to your profile.
...
----
<1> The plugin repository you need to add to the settings.xml file.


Once you have done this, you are ready to use Rest SDK.
