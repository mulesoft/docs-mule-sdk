...
Hypermedia paging:: For APIs which do paging retrieving in the
response body o in the Link header the URL of the next page.
...
The connector will stop the pagination once that page is retrieved.
...
nextUrl:: This is a dataweave expression that the connector
