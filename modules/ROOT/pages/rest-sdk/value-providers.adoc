...
attributes:: The response attributes returned from the server. These resemble the xref:https://docs.mulesoft.com/http-connector/1.5/http-documentation#HttpResponseAttributes [HTTP Connector Response Attributes].
