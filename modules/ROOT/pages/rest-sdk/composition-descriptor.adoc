...
Simple composition is defined in a file called the Composition Descriptor, an
instance of an existing descriptor. 
The result of the connector created using this file is versioned and released
