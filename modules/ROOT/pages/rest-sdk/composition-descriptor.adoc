...
Simple composition is defined in a customization layer file, which is an
...
----
mvn com.mulesoft.connectivity:rest-sdk-mojo:<PLUGIN_VERSION>:createConnector -DapiSpec=api.raml -Ddescriptor=specialist-descriptor.yaml,customization-layer.yaml
----
