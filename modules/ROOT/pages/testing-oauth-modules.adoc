...
To overcome this challenge, you can use the Storage Event processor to bypass the OAuth dance by manually providing a valid access token. Ensure the following requirements are met:
