...
----
mvn org.mule.extensions:mule-extensions-archetype-maven-plugin:1.11.0:generate
----
...
NOTE: The generated POM defines a Minimum Mule Version by default, that version must be compatible with the target Mule version. See xref:forward-compatibility.adoc[Forward Compatibility] for more information on how to configure and work with Minimum Mule Versions.
