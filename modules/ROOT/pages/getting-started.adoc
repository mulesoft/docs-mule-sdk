...
+
NOTE: The `mule-extensions-parent` isn't compatible with Apache Maven 3.9.x. From the ETA perspective of actual compatibility of Maven 3.9.1, it will be done with the Mule Runtime Release 4.8.
