...
+
NOTE: The maximum supported version for running your applications is JDK 17 for Mule runtime 4.6.x and later. During the packaging of your app, the custom code *must* be compiled for Java language level 1.8.
...
image::intellij-config.png["Navigation path to the command line parameter input field.",600,600]
