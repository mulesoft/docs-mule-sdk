...
image::eclipse-config.gif[600,600]
...
NOTE: Different features are available in different vesions of the SDK for Java. See xref:choosing-version.adoc[Choosing the SDK version] to pick the right version for your connector.