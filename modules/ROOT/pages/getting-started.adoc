...
+
NOTE: The maximum supported version for Java SDK is JDK 11, however, you can use JDK 11 only for running your application. Compilation with Java SDK must be done with JDK 8.
