...
+
NOTE: The maximum supported version for running your applications is JDK 17. However, if there is custom Java code in your application, then during packaging, the custom code is always compiled using JDK 8. 
