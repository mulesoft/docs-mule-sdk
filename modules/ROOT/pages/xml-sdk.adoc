...
| required
|
| The type of error code to throw (or remap) in the `<body>`. More info about xref:4.1@mule4-runtime::mule-error-concept.adoc[Mule Error concept].
...
The XML SDK relies on xref:4.1@mule4-runtime::mule-error-concept.adoc#about-error-mappings[error mappings] for the former. For the latter, the xref:4.1@mule4-runtime::raise-error-component-reference.adoc[raise error component] is used.
