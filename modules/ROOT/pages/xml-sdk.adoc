...
* Java Development Kit 17 (JDK 17) or earlier to compile and build your custom Java code.
** For preexisting connectors, xref:java-version-support.adoc#jdk_8[JDK 8 might be needed].
* Apache Maven 3.9.8 or later to manage your project’s build.
...
The following XML SDK module sends requests to https://docs.github.com/en/rest/users[GitHub API V3] to retrieve an authenticated user:
