...
Note that unlike xref:metadata.adoc[Metadata], which is meant to discover the dynamic types of a parameter, this feature is designed to help to provide the possible values of a parameter.
