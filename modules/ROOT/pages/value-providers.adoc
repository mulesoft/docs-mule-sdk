...
+
image::value-provider-static.gif["Workflow of selecting a predefined value or defining a custom value"]
...
+
image::value-provider-months.gif["Example of value provider with context parameters"]
