...
=== To Discover only latest patches

If you want to discover only the latest patch versions of the runtime you can add the following
line to the runtime configuration:
...
NOTE: If any of the suite files or resources is not present in the classpath, the plugin will fail.
