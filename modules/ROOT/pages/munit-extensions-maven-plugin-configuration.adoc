...
To solve this, use the MUnit Extensions Maven plugin that comes with a built-in feature to do just that.


The easy solution to this problem is to have your test use a free port.
The MUnit Extensions Maven plugin comes with a built-in feature to do just that.
