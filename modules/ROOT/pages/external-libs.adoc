...
[NOTE]
=======
For custom connectors, all Maven dependencies must be accessible from Anypoint Exchange. Maven dependencies published to Anypoint Exchange, Maven Central, or MuleSoft repositories are accessible from Anypoint Exchange, while Maven dependencies published to other private or public repositories are unaccessible from Anypoint Exchange.
