...
[NOTE]
=======
For custom connectors, all Maven dependencies must be accessible from Anypoint Exchange. Maven dependencies from Anypoint Exchange, Maven Central, or MuleSoft repositories are accessible from Exchange, while Maven dependencies from other private or public repositories are unaccessible from Anypoint Exchange.
