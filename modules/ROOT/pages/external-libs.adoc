...
[NOTE]
=======
For custom connectors, all Maven dependencies must be accessible from Anypoint Exchange. Maven dependencies published to private or public repositories are unaccessible from Anypoint Exchange.
