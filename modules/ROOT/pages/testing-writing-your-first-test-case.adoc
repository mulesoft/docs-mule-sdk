...
NOTE: This guide uses FlowRunner, which is deprecated. To test your modules, refer to the xref:mtf.adoc[MTF] documentation instead.
...
Learn how to test a module using this example and refer to that documentation for the parent dependency, which includes all the dependencies required to build the test case. To export packages, refer to xref:mule-runtime::how-to-export-resources.adoc[]. 
...
NOTE: If you want to compile connectors with Java 17, use version 1.9.0.
...
image::first-test-app.png["Basic example of a Mule app"]
