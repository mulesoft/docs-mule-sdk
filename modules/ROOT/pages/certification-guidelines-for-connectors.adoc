...
If you are creating a connector that you wish to have certified (not Select or Premium), create your connector and prepare it for certification.
...
----
+
. Add a folder named `icon` insert the Connector Icon (SVG format): `connector_root_project/icon/icon.svg`.
+
...
+
. Identify a location where you will host documentation, and add a user guide and reference manual based on the templates https://drive.google.com/file/d/1jB4uDCjOFhPtEttmnTxYERktdzd0AwSF/view[user-manual.adoc] and https://drive.google.com/file/d/1ZzJGJAN8pIOx_mI9d2xKTAXt-tubcwSS/view?usp=sharing[release-notes.adoc]. Link to them from the Exchange asset you create in the next step.
