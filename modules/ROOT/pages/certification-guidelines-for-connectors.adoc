...
* Add the following docs (https://drive.google.com/file/d/1jB4uDCjOFhPtEttmnTxYERktdzd0AwSF/view[user-manual.adoc] and https://drive.google.com/file/d/1ZzJGJAN8pIOx_mI9d2xKTAXt-tubcwSS/view?usp=sharing[release-notes.adoc]) to the `doc` folder.
+
...
xref:4.1@mule4-runtime::index.adoc[About Mule Runtime]
