...
+
If this is your first connector, use `1.0.0`. If not, create the major version from your last connector. For example, the connector version is `v2.0.0`.
** When you receive a request for the main package of your extension, accept the default.
// TODO TD-0302251: update this section once a new mule-certified-parent exists
...
* The steps described in this guide let you create a structure of a connector project.
...
https://www.youtube.com/watch?v=qdOXKj8V9Lc&feature=youtu.be[Mule 4 SDK] (video)

https://trailhead.salesforce.com/trailblazer-community/neighborhoods/mulesoft[MuleSoft Trailblazer Community]

xref:best-practices.adoc[Best Practices]

https://github.com/enterprises/salesforce-emu/sso?return_to=https://github.com/mulesoft-emu/mule4-slack-connector[Slack Connector]
