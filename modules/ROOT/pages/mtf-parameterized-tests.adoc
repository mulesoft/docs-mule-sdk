...
Use a parameterized suite to run the same tests with different inputs. For more information, refer to xref:munit::munit-parameterized.adoc[MUnit Parameterized Test Suite].
