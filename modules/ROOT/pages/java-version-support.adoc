...
[[bytecode_level]]
. Ensure the bytecode level of the compiled classes of your custom module can be used in the lowest supported Java version. Use the Java compiler configuration from the Java SDK parent POM instead of modifying it, for example:
+
[source,xml,linenums]
----
    <parent>
