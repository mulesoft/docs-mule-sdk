...
to identify which is the `MetadataType` required by the app developer. Refer to xref:metadata.adoc#component-metadata[] for more information about the `MetadataType`.
