...
You must validate the error types and error descriptions that your module throws.

== Prerequisites

* You must know how to define the errors that your module throws. For more information, refer to xref:errors.adoc[Errors Definition].

== Example

Suppose there is a module that defines errors as follows:
