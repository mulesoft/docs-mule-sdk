...
* Upgrade to `mule-java-extension-parent` version 1.11.0 or later and use xref:forward-compatibility.adoc[Forward Compatibility] to properly configure your module's Minimum Mule Version
