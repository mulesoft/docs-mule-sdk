...
Starting August 1, 2026, Exchange requires `mule-extensions-maven-plugin` version 1.9.0 or later to publish connectors and Mule plugins. This version writes Java compatibility metadata to `mule-artifact.json` during build time.
