...
* If you use Mule SDK, upgrade to a version that includes `mule-extension-plugin` version 1.9.0 or later.

* If you manually configure plugins, update your POM file to reference `mule-extension-plugin` version 1.9.0 or later.
+
[source,xml]
----
<plugin>
