...
The following examples provide the basic test structure for testing the metadata defined for your Module.

== Prerequesites

* You are familiarized with how to define metadata in your module. +
...
The following test validates the `Metadata Type` returned by the operation:
...
In the previous example, the module throws a `MetadataResolvingException` when the parameter is null or empty.
