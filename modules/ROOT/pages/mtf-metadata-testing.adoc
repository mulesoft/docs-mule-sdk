...
* Know how to define metadata in your module. For more information, refer to xref:metadata.adoc[].
* To create metadata tests, add the `mtf-tools` dependency to your project:
+
[source,xml,linenums]
----
<dependency>
