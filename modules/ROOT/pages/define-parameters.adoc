...
POJO parameters (regardless if they are used with the @ParameterGroup annotation) *must* override the *equals* and
...
Even if no configurations have POJO parameters, it is still required that they override *equals* and *hashCode* as future
