...
You cannot add parameters or POJOs with types _org.mule.runtime.core.api.source.scheduler.Scheduler_ or _org.mule.runtime.api.scheduler.SchedulingStrategy_. Mule runtime and the SDK adds parameters of these types, for example, in polling sources.
