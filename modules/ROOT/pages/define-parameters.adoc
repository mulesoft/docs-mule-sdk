...
*hashCode* methods for internals of the mule runtime to function correctly. Below is an example from a class in the
Database Connector that illustrates how to do this:
[source,java,linenums]
----
/**
