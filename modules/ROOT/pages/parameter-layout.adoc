...
image::example.png["Example of a parameter that takes values"]
...
image::summary.png["Example of a tooltip that provides a summary of a parameter"]
...
image::placement-tab.png["Example list of tabs"]
...
image::text.png["Example of a large text input"]
...
.Example in the UI
image::password.png["Example of a password input"]
