...
|NOT_SUPPORTED
|N.A.
|A reference to the Proxy configuration to be used to perform the validation against. 

|`authServerTlsContext`
|NO
|NOT_SUPPORTED
|N.A.
|A reference to the TLS Context configuration to be used to perform the validation (which should have the trust store configured). 
|===
...
In the case of setting a TLS Context configuration for the authorization: 
[source, java, linenums]
----
<sfdc:config name="salesforce">
    <sfdc:client-credentials-connection display="PAGE" immediate="FALSE" prompt="CONSENT">
...
In the case of setting a Proxy configuration for the authorization: 
[source, java, linenums]
----
<sfdc:config name="salesforce">
    <sfdc:client-credentials-connection display="PAGE" immediate="FALSE" prompt="CONSENT">
